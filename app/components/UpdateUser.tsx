...
import { onboardUser, UpdateUser } from "../actions";
...
export function UpdateUserRoute({ data }: iAppProps) {
  const [lastResult, formAction] = useActionState(UpdateUser, undefined);
  ...
  const [imgBase64, setImgBase64] = useState(data.image || "");
